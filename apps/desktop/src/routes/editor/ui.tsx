...
export function IconCapMessageBubble(props: ComponentProps<"svg">) {
  return (
    <svg
...
export function IconCapChevronDown(props: ComponentProps<"svg">) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
export function IconCapCursor(props: ComponentProps<"svg">) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
export function IconCapImage(props: ComponentProps<"svg">) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
